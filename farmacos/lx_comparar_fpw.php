...
if ($categoria_farmaco=='FAM'){
$query_farmacos="select descripcion_categoria_diana from categorias_dianas where id_categoria_diana='".$id_farmaco."'";
}
...
$lista2=$_GET['lista2'];
$lista3=$_GET['lista3'];
if ($lista2==0 or ($lista1==0 and $lista3==0)){
echo "no se compara";
echo $lista1;
echo $lista2;
echo $lista3;
...
$array_lista_fam=explode("x",substr($lista3,0,-1));
if ($lista1!=0){
...
//comparacion familias si hay familias
if ($lista3!=0){
while (list ($codfamily,$id_family) = each ($array_lista_fam)){
			while (list ($codf,$idf) = each ($array_lista_fda)){
						  $nombre_farmaco_fda=devuelve_nombre_farmaco($idf,'FDA');
						  $nombre_familia=devuelve_nombre_farmaco($id_family,'FAM');
						  echo "<div class=\"span-23 last\">\n";
						  echo "<div class=\"span-8\">\n";
							  echo "<div class=\"izq conborde\">\n";
								   echo "<div class=\"cabecera1\" onMouseOver=\"actualiza_div_fam($idf,$id_family)\">\n";
									 echo "<p class=\"leyenda\">$nombre_familia</p>\n";								  
								   echo " </div>\n";
								   echo "<div class=\"cuerpo1\">\n";
									  echo "<div class=\"scroll200h\">\n";
										  	echo "<div id=\"ctoxicidades2f_".$idf."_".$id_family."\">\n";
											echo "</div>\n";
															 //lista_toxicidades_farmaco_inv($id_farmaco2);		
									  echo "</div>\n";
								  echo "</div>\n";
						  ...
						  echo "<div class=\"span-8\">\n";
									  echo "<div class=\"izq conborde\">\n";
										   echo "<div class=\"cabecera1\" onMouseOver=\"actualiza_div_ffda2($idf,$id_family)\">\n";
											   
											  echo "<p class=\"leyenda\">$nombre_farmaco_fda</p>\n";
										  echo "</div>\n";
										  echo "<div class=\"cuerpo1\">\n";
											  echo "<div class=\"scroll200h\">\n";
												  echo "<div id=\"ctoxicidades1f_".$idf."_".$id_family."\">\n";
												echo "</div>\n";
												  //lista_toxicidades_farmaco_fda($idf);			
						  ...
						  echo "<div class=\"span-7 last\">\n";
									  echo "<div class=\"dcha conborde\">\n";
										  ...
										  echo "</div>\n";
											  echo "<div class=\"cuerpo1\">\n";
												  echo "<div class=\"scroll200h\">\n";
												  comparar_fam_fda($id_family,$idf);
												  echo "</div>\n";
											  echo "</div>\n";
									  echo "</div>\n";
						echo "</div>\n";
