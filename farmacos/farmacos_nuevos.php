					...
					echo "<div class=\"span-0\"><a class=\"blineatabla bpdf\" href=\"javascript:abrir_ventana('".$link_pathway."')\"></a></div>\n";
						if ($nivel > 1){
							...
							*/
							...
							if( $GLOBALS['cabecera']->admin_lvl <= $_SESSION['UNIVEL']) echo "<div class=\"span-0\"><a class=\"blineatabla bpapelera\" href=\"javascript:aviso_borrar_pathway('".$id_farmaco."','".$id_pathway."')\"></a></div>\n";
	...
	echo "<div id=\"tabBody\" class=\"clearfix\">\n";
		echo "<form  name=\"form_farmacos\">\n";
			...
			echo "<div class=\"span-23 last\">\n";
				...
				if( $GLOBALS['cabecera']->admin_lvl <= $_SESSION['UNIVEL']) echo "<a class=\"botoncabecera badd\" href=\"javascript:abrir_ventana('ventanas_inv.php?cop=afn')\"></a>\n";
				echo "</div>\n";
				...
				$numero_categorias=mysql_num_rows($resultado_categorias);
					...
					while(list($id_categoria_diana,$descripcion_categoria_diana)= mysql_fetch_row($resultado_categorias)){
						 ...
						 * MENU OCULTO
						 */
						//echo $descripcion_categoria_diana."-----  ".strcmp(strtoupper($descripcion_categoria_diana)," MENU OCULTO RECLUTING")."<br>";
						if (strcmp(strtoupper($descripcion_categoria_diana)," MENU OCULTO RECLUTING") != 0)
						{
							...
							if ($resultado){
								...
								while(list($id_farmaco,$nombre_farmaco,$autores,$categoria_diana,$tx1desc,$tx2desc,$comentarios,$tipo_ensayo)= mysql_fetch_row($resultado)){
									...
									*/
									...
									if( $GLOBALS['cabecera']->admin_lvl <= $_SESSION['UNIVEL']) echo "<div class=\"span-1\"><a class=\"blineatabla bpapelera\" href=\"javascript:aviso_borrar_farmaco('".$id_farmaco."')\"></a></div>\n";
									...
									*/
									...
									if( $GLOBALS['cabecera']->admin_lvl <= $_SESSION['UNIVEL']) echo "<div class=\"span-0\"><a class=\"blineatabla bedit\" href=\"farmacos_nuevos.php?cop=efn&id_farmaco=".$id_farmaco."\"></a></div>\n";
