...
$id_fda=$_GET['id_farmaco1'];
$id_categoria_diana=$_GET['id_categoria_diana'];
comparar_fam_fda($id_categoria_diana,$id_fda);
...
$query_grptx_f2="select toxicidad_n0.id_toxicidad_n0,descripcion_toxicidad_n0,categorias_diana_toxicidad.id_toxicidad,nombre_toxicidad 
		from categorias_diana_toxicidad,toxicidad,toxicidad_n0 where
						...
						if($numero_toxicidades_grp == 0) {
							...
							while(list($id_toxicidad)= mysql_fetch_row($lista_toxicidades_grp)){
								...
								echo "<li class=\"cab_fila\">\n";
									...
									$tx12=devuelve_toxicidad_familia($id_categoria_diana,$id_toxicidad);
