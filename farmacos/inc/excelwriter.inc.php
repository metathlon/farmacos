...
EOH;
		...
		*/
		...
		function writeLine($line_arr)
		{
			...
			fwrite($this->fp,"<td class=xl24>$col</td>");
			fwrite($this->fp,"</tr>");
		}
		...
		*/
		function writeCol($value)
		{
			...
			fwrite($this->fp,"<td class=xl24 width=153 >$value</td>");
			//fwrite($this->fp,"<td class=xl24 width=64 >$value</td>");
		}
	function writeColNum($value)
		{
			if($this->state!="OPENED")
			{
				$this->error="Error : Please open the file.";
			...
			$value_coma=str_replace(".",",", $value);
			
			fwrite($this->fp,"<td align=right x:num=\"$value\">$value_coma</td>");
			//fwrite($this->fp,"<td class=xl24 width=64 >$value</td>");
		}
