...
p#botonB11 a{
background:url(img/botonB11.png)0px 0px;
}
p#botonB11 a:hover{
background:url(img/botonB11.png)0px 84px;
}
p#botonB12 a{
background:url(img/botonB12.png)0px 0px;
}
p#botonB12 a:hover{
background:url(img/botonB12.png)0px 84px;
}
p#botonB13 a{
background:url(img/botonB13.png)0px 0px;
}
p#botonB13 a:hover{
background:url(img/botonB13.png)0px 84px;
}
...
#nav{
	...
	float:left;
	height:40px;
	background:url(img/nav_bg_c.png) no-repeat right;
	background-color:#275907;
	margin:0;
	padding:0;
	width:100%;
}
