...
#cabecera-menuah{
background:url(img/imagen_a1.jpg) no-repeat right;
background-color:rgb(6,62,93);
height:40;
}
p#botonA11 a,p#botonA11 a:hover,p#botonA12 a,p#botonA12 a:hover,p#botonA13 a,p#botonA13 a:hover{
margin:0 auto;
width:250px;
height:79px;
display:block;
	...
	<div class="span-24 last append-bottom">
        ...
        if ($array_menu_superior){
			while (list ($v_url,$v_menu) = each ($array_menu_superior)){
				...
				echo "<li>&nbsp;<li>\n";
				echo "<li><a href=\"paginaa1.php\">Combinational studies </a></li>\n";
		}
	  ...
	  ?>          
		...
		<div class="span-24 last">
            ...
            */
			...
			{
				echo "<li><a href='exportar_inv.php'>Exportar Investigational</a></li>";
				echo "<li><a href='exportar_fda2.php'>Exportar FDA 2</a> </li>";
				echo "<li><a href='exportar_fda1.php'>Exportar FDA 1</a></li>";
             	echo "<li><a href='categorias.php?cop=lpw'>Administrar Tablas</a></li>";
			}
            ?>
