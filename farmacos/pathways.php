...
echo "<div class=\"span-24 last\">\n";
	echo "<div id=\"tabBody\" class=\"clearfix\">\n";
			...
			echo "<div class=\"span-23 last\">\n";
				...
				echo "<div class=\"titulorecuadro\"> Pathways obtained from gene mutation data</div>\n";
				...
				echo "<ul class=\"m0\">\n";
					echo "<li class=\"cabecera cab_gris clearfix\">\n"; 
						...
						echo "<div class=\"span-15\">&nbsp;&nbsp;&nbsp;Pathway Name</div>\n";
						echo "<div class=\"span-4\"># of Mutations</div>\n";
				...
				$numero_pathways=mysql_num_rows($resultado_pathways);
					...
					while(list($id_pathway,$id_external,$nombre_pathway)= mysql_fetch_row($resultado_pathways)){
							...
							echo "<li class=\"$dcolor\">\n";
								...
								//echo "<div class=\"span-2\"><a href=\"pathways.php?cop=vpw&id_pathway=".$id_pathway."\">$id_external</a></div>\n";
								echo "<div class=\"span-15\">$nombre_pathway</div>\n";
								echo "<div class=\"span-4\" style=\"text-align='center'; display='table-cell';\">$numero_mutaciones</div>\n";
								echo "<div class=\"span-1\"><a class=\"blineatabla bpdf\" href=\"javascript:abrir_ventana('".$link_pathway."')\"></a></div>\n";
								echo "<div class=\"clear\"></div>\n";
							echo "</li>\n";
							$a = ($dcolor == $dcolor_A ? 1 : 0);
							}
