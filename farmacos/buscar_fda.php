				    ...
				    if($numero_farmacos == 0) {
						...
						$dcolor = ($a == 0 ? $dcolor_A : $dcolor_B);
							echo "<li class=\"$dcolor\">\n";
								...
								echo "<div class=\"span-0\"><a class=\"blineatabla bbuscar\" title=\"View Details\"  href=\"javascript:abrir_ventana('ventanas_info.php?cop=vf&id_farmaco=".$id_farmaco."')\"></a></div>\n";
